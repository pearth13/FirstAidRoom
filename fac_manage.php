            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">การจัดการคณะ/หน่วยงาน</h1>
                        <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" href="#" data-toggle="modal" data-target="#adduserModal"><i
                                class="fas fa-download fa-sm text-white-50"></i> เพิ่มคณะ/หน่วยงาน</a>
                    </div>
                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">ตารางข้อมูลคณะ/หน่วยงาน</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tfoot>
                                        <tr>
                                            <th>ที่</th>
                                            <th>ชื่อผู้คณะหน่วยงาน</th>
                                            <th>สถานะ</th>
                                            <th>ตัวเลือก</th>
                                        </tr>
                                    </tfoot>
                                    <tbody>
                                    <?php $sqlr = "SELECT * FROM `fac` WHERE fac_status = 1 " ;
                                        ...
                                        <td> <?php echo $x++; ?></td>
                                            ...
                                            <td><div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu"> 
                                                    <li><a class="dropdown-item" href="update_fac.php?facId=<?php echo $row['fac_id']; ?>"> <i class="fas fa-users"></i> แก้ไขข้อมูล</a></li>
                                                    <li><a class="dropdown-item" href="php_action/removeFac.php?facId=<?php echo $row['fac_id']; ?>"> <i class="fas fa-trash"> ลบ</i></a></li>       
                                                </ul>
                                                </div></td>
                                        </tr>
                                        <?php } ?>
...
<div class="modal fade" id="adduserModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">เพิ่มข้อมูลคณะ/หน่วยงาน</h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <div class="modal-body">
                <form class="form-horizontal" action="php_action/createFac.php" method="post" >
                <div class="form-group">
                    <div><input type="text" class="form-control" id="facName" placeholder="กรอกชื่อคณะ/หน่วยงาน" name="facName" autocomplete="off" required></div>
                </div>           
                <div class="modal-footer">
                    <button class="btn btn-secondary" type="button" data-dismiss="modal">ยกเลิก</button>
                    <button class="btn btn-primary" type="submit" name="submit" id="submit"></i> เพิ่มข้อมูลคณะ/หน่วยงาน</button> </form>
                </div>
            </div>
        </div>
    </div>
