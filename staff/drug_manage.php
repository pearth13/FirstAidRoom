                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">การจัดการยาในระบบ</h1>
                            <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" href="#" data-toggle="modal" data-target="#adduserModal"><i class="fas fa-download fa-sm text-white-50"></i> เพิ่มยาในระบบ</a>
                        </div>
                        <!-- DataTales Example -->
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">ตารางข้อมูลยา</h6>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <?php $sqlr = "SELECT product.product_id, product.product_name, product.brand_id,
                                                product.categories_id, product.quantity, product.date, product.active, product.status, product.typed,
                                                brands.brand_name, categories.categories_name, brands.yearlot   FROM product 
                                            ...
                                            while ($row = $resulto->fetch_array()) {
                                                ...
                                                $yearProcress = $row['yearlot'] + 543;
                                                $brand = $row['brand_name'] . " (" . $yearProcress . ")";
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $popdm . $popy; ?></td>
                                                    <td><?php echo $row['quantity'] . " " . $typed; ?></td>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li><a class="dropdown-item" href="update_product.php?productId=<?php echo $row['product_id']; ?>"> <i class="fas fa-capsules"></i> แก้ไขข้อมูล</a></li>
                                                                <li><a class="dropdown-item" href="php_action/removeProduct.php?productId=<?php echo $row['product_id']; ?>"> <i class="fas fa-trash"> ลบ</i></a></li>
                                                            </ul>
                                                        </div>
                                                    </td>
                                                </tr>
        ...
        <div class="modal fade" id="adduserModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="form-horizontal" action="php_action/createProduct.php" method="post">
                            <div class="form-group row">
                                <div class="col-sm-6 mb-3 mb-sm-0">ชื่อของยา<input type="text" class="form-control" id="productName" placeholder="กรอกชื่อยา" name="productName" autocomplete="off" required></div>
                                <div class="col-sm-6"> จำนวนของยา<input type="number" class="form-control" id="quantity" placeholder="จำนวนยา" name="quantity" autocomplete="off" required> </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-6 mb-3 mb-sm-0">จำนวนนับของยา<select class="form-control" id="typed" name="typed" required>
                                        <option value="">~~เลือกจำนวนนับยา~~</option>
                                ...
                                <div class="col-sm-6"> ประเภทของยา <select class="form-control" id="categoryName" name="categoryName" required>
                                        <option value="">~~เลือกประเภทยา~~</option>
                                        <?php
                                        $sqlx = "SELECT categories_id, categories_name, categories_active, categories_status FROM categories WHERE categories_status = 1 AND categories_active = 1";
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6 mb-3 mb-sm-0"> ล็อตของการนำเข้ายา<select class="form-control" id="brandName" name="brandName">
                                        <option value="">~~เลือกล็อตการนำเข้า~~</option>
                                        <?php
                                        $sqlx = "SELECT * FROM brands WHERE brand_status = 1 AND brand_active = 1";
                                        $resultx = $connect->query($sqlx);
                                        while ($rowx = $resultx->fetch_array()) {
                                            $year = $rowx[1];
                                            $yearProcress = $year + 543;
                                            echo "<option value='" . $rowx[0] . "'>" . $rowx[2] . " (" . $yearProcress . ")</option>";
                                        }    ?>
                                    </select></div>
                                <div class="col-sm-6"> เลือกวันที่หมดอายุยา<input type="date" class="form-control" id="date" placeholder="วันหมดอายุยา" name="date" autocomplete="off"> </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="modal-footer">
                                <button class="btn btn-secondary" type="button" data-dismiss="modal">ยกเลิก</button>
                                <button class="btn btn-primary" type="submit" name="submit" id="submit"></i> เพิ่มข้อมูล</button>
                        </form>
                    </div>
                </div>
            </div>
