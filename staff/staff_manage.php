            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">ประเภทข้อมูลเจ้าหน้าที่:</h6>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">การจัดการข้อมูลเจ้าหน้าที่</h1>
                        <!--a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" href="#" data-toggle="modal" data-target="#adduserModal"><i
                                class="fas fa-download fa-sm text-white-50"></i> เพิ่มเจ้าหน้าที่</!--a-->
                    </div>
                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">ตารางเจ้าหน้าที่</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                    <?php $sqlr = "SELECT user.user_id, user.user_namel, user.fac_id,
                                                    user.tel, user.username, user.password, user.active, user.status, 
                                                    user.Ulevel, user.cata, user.druga, fac.fac_name FROM user 
                                                    INNER JOIN fac ON user.fac_id = fac.fac_id		
                                                    WHERE user.status = 1 AND Ulevel != 3" ;
                                        ...
                                        <tr>
                                        <td> <?php echo $x++; ?></td>
                                            <td><?php echo $row['user_namel']; ?></td>
                                            <td><?php echo $row['tel']; ?></td>
                                            <td><?php echo $row['fac_name']; ?></td>
                                            <td><?php $cata = $row['cata'];
                                            if ($cata == 1){
                                                $catat ="นักศึกษา";
                                              }elseif($cata == 2){
                                                $catat ="คณาจารย์";
                                            ...
                                            <!--td><div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu"> 
                                                    <li><a class="dropdown-item" href="update_staff.php?userId=<?php echo $row['user_id']; ?>"> <i class="fas fa-user-edit"></i> แก้ไขข้อมูล</a></li>
                                                    <li><a class="dropdown-item" href="php_action/removestaff.php?UserId=<?php echo $row['user_id']; ?>"> <i class="fas fa-trash"> ลบ</i></a></li>       
                                                </ul>
                                                </div></!--td-->
                                        </tr>
                                        <?php } ?>
...
<!-- profile Modal-->
    <div class="modal fade" id="sefeModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            ...
            <hr>
              <p class="lead fw-normal text-muted mb-1">ชื่อเจ้าหน้าที่: <?php echo $result['user_namel']; ?></p>
...
<div class="modal fade" id="adduserModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">เพิ่มข้อมูลเจ้าหน้าที่</h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <div class="modal-body">
                <form class="form-horizontal" action="php_action/createstaff.php" method="post" >
                <div class="form-group row">
                    <div class="col-sm-6 mb-3 mb-sm-0"><input type="text" class="form-control" id="userNamel" placeholder="กรอกชื่อ-สกุล" name="userNamel" autocomplete="off" required></div>                                    
                    <div class="col-sm-6"> <input type="text" class="form-control" id="tel" placeholder="กรอกเบอร์โทรหรือมือถือ" max="10" name="tel" autocomplete="off" required></div>
                </div>
                <div class="form-group">
                    <input type="text" class="form-control" id="druga" placeholder="การแพ้ยา" name="druga" autocomplete="off"></div>
                <div class="form-group row">
                <div class="col-sm-6 mb-3 mb-sm-0" ><select class="form-control" id="cata" name="cata" required>
                ...
                <div class="form-group row">
				      <div class="col-sm-6 mb-3 mb-sm-0"><input type="text" class="form-control" id="username" placeholder="กรอกชื่อเจ้าหน้าที่ Username" name="username" autocomplete="off" required></div>
				      <div class="col-sm-6"><input type="text" class="form-control" id="password" placeholder="กรอกรหัสผ่าน Password" name="password" autocomplete="off" required></div>
                </div>                    
                <div class="modal-footer">
                    <button class="btn btn-secondary" type="button" data-dismiss="modal">ยกเลิก</button>
                    <button class="btn btn-primary" type="submit" name="submit" id="submit"></i> เพิ่มข้อมูลผู้รับบริการระบบ</button> </form>
                </div>
            </div>
        </div>
    </div>
