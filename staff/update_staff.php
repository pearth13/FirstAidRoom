...
<head>
    ...
    <title>VRU FirstAid - แก้ไขเจ้าหน้าที่</title>
    ...
    <div class="container">
        <div class="card o-hidden border-0 shadow-lg my-5">
            <div class="card-body p-0">
                ...
                <div class="row">
                    <div class="col-lg-5 d-none d-lg-block"><img src="..\img\b.png" alt="HTML tutorial" style="width:100%;height:100%;"></div>
                        <div class="col-lg-7">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4">แก้ไขเจ้าหน้าที่</h1>
                                </div>
                                    <?php 
                                    $userId = $_GET['userId'];
                                ...
                                <form method="POST" action="php_action\editstaff.php?userId=<?php echo $userId; ?>" class="user"> <!--fromRegister-->
                                    <div class="form-group row">
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                        <p>ชื่อเจ้าหน้าที่</p><input for="userNamel" type="text" id="userNamel" name="userNamel" class="form-control " 
                                                value="<?php echo $row['user_namel'] ?>" >
                                        </div>
                                        <div class="col-sm-6">
                                        <p>เบอร์โทร</p><input for="tel" type="text" id="tel" name="tel"class="form-control"  max="10" 
                                            value="<?php echo $row['tel'] ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            <p>คณะ/หน่วยงาน</p><select class="form-control" id="facName" name="facName">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            <p>Username</p><input for="username" type="text" id="username" name="username" class="form-control" 
                                     ...
                                     <div class="col-sm-6 ">
                                        <?php $active = $row['active']; if($active == 1){
                                            ...
                                            <p>เปิด-ปิด การเปิดใช้งานเจ้าหน้าที่</p><select class="form-control" id="active" name="active" >
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                        <p>แก้ไขรหัสผ่าน</p><input for="editPassword" type="password" id="editPassword" name="editPassword" class="form-control " 
                                    ...
                                    <a href="staff_manage.php" class="btn btn-secondary btn-user btn-block">
                                    <i class=""></i> ยกเลิก</a> 
                                <?php }  ?>
                            </div>
                        </div>
